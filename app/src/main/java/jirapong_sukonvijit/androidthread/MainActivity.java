package jirapong_sukonvijit.androidthread;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void threadImage() throws IOException {
        final URL url = new URL("https://data.whicdn.com/images/110412140/original.jpg");
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.asyncLoadButton:
                ...
                new LoadImageTask().execute("https://data.whicdn.com/images/37240176/large.jpg");
            default:
                break;
        }
    }
